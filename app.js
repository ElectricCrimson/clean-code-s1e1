...
var incompleteTaskHolder=document.querySelector(".list_active");//ul of .active-tasks
var completedTasksHolder=document.querySelector(".list_done");//.list_done
...
var taskCompleted=function(){
  ...
  //Append the task list item to the #list_done
  var listItem=this.parentNode;
